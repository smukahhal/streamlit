...
st.title('Building a Data Dashboard with Stremlit')
st.subheader('while exploring COVID-19 data')

####### In scope Countries
countrylist = df1.columns.tolist()
countrylist1 = ['United Kingdom', 'US', 'Italy', 'Switzerland']
...
# Check box to show the Pic Chart data.
...
## Show underlying data for line Graph
...
slide = st.slider('Slide acrss to explore infection spread', 0, maxslide, 10)
...
# st.markdown('Or a `print("Solie")` markdown.')

# x = st.multiselect('Text to display', ['Option1','Option2','Option3'], ['Option1'])
